...
class schoolNewsController extends GetxController {
  UserData userData = Get.put(UserData());
  ApiRespository apiRespository = ApiRespository(apiClient:Get.find());
  Rx<SchoolNews>booksModelObj = SchoolNews().obs;
  // Rx<IssuedBook>issuedBookModelObj = IssuedBook().obs;
  RxList<SchoolNews> issuedBookModelObj = <SchoolNews>[].obs;
  ...
  Future<void> getData() async
  {
    ...
    {
      d.add(SchoolNews.fromJson(data.body[i]));
    }
