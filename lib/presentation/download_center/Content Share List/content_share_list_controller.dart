...
import 'content_share_list_modal.dart';

class ContentShareController extends GetxController{

  TextEditingController searchC = TextEditingController();
  ApiRespository apiRespository = ApiRespository(apiClient: Get.find());
  Rx<ContentShareList> filteredContentTypeList = ContentShareList().obs;
  ...
  Future<void> initializeData() async  {
    ...
    try
    {
      ...
      filteredContentTypeList.value = ContentShareList.fromJson(data.body);
