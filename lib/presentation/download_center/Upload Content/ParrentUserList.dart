class ParentUser {
  ...
  ParentUser({this.status, this.error, this.message, this.data});
...
class Data {
  ...
  Data({this.classId, this.id, this.guardianUserId, this.parentId, this.className, this.sectionId, this.section, this.admissionNo, this.rollNo, this.admissionDate, this.firstname, this.middlename, this.lastname, this.image, this.mobileno, this.email, this.state, this.city, this.pincode, this.religion, this.dob, this.currentAddress, this.permanentAddress, this.categoryId, this.category, this.adharNo, this.samagraId, this.bankAccountNo, this.bankName, this.ifscCode, this.fatherName, this.guardianName, this.guardianRelation, this.guardianPhone, this.guardianAddress, this.isActive, this.createdAt, this.updatedAt, this.gender, this.guardianEmail, this.rte, this.sessionId, this.appKey, this.parentAppKey});

  Data.fromJson(Map<String, dynamic> json) {
  classId = json['class_id'];
  id = json['id'];
  guardianUserId = json['guardian_user_id'];
  ...
  data['id'] = this.id;
  data['guardian_user_id'] = this.guardianUserId;
