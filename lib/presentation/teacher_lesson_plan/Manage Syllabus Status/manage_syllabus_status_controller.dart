...
import 'manage_syllabus_status_modal.dart';

class ManageSyllabusStatusController extends GetxController {
  UserData userData = Get.put(UserData());
  ApiRespository apiRespository = ApiRespository(apiClient:Get.find());
  Rx<ManageSyllabusStatusModal> lessonPlanModelObj = ManageSyllabusStatusModal().obs;
